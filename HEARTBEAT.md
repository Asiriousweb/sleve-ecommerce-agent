...
| **Google Ads** | 🟢 | **DIRECTO (Explorer access, SIN formulario Basic)** vía delegación de dominio Workspace + Ads API **v23**. `_google_ads: ok (3/4)` — CL/CO/MX OK; **Perú 403 "caller does not have permission"** → falta aceptar el vínculo de `276-852-0390` al MCC. Requirió: habilitar "Google Ads API" en GCP + delegación (scope adwords) + token en Railway. MCC `137-819-4398`. Cuentas en USD (Chile) → FX ya normaliza. Formulario Basic = **innecesario** (se mandó igual, en pausa) |
