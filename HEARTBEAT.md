...
| **Google Ads** | 🟡 | DIRECTO **construido** (`pull_google_ads`, Ads API vía delegación de dominio Workspace; reemplaza Windsor con fallback). MCC `137-819-4398`; cuentas vinculadas: CL `398-306-6786`, CO `561-236-0195`, MX `451-097-9976`, PE `276-852-0390`. IDs + `GOOGLE_ADS_IMPERSONATE` en Railway. **Pendiente: developer token Basic access (solicitado 2026-06-29, ~3 días) + delegación de dominio**; probar si "Explorer access" ya sirve. Cuentas en USD (Chile) → ojo FX |
