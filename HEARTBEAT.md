...
| **Search Console** | 🟡 | Código directo listo (`pull_search_console`, mismo service account). Espera `SC_SITE_CL/CO/PE` (formato `sc-domain:sleve.cl`) + permiso al email de la SA. MX sin propiedad. Sitio activo = `sleve.X` (sleve.cl tiene 15.6k clics) |
