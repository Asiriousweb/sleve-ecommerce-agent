...
| **Loop datos en vivo** | 🟢 | **FUNCIONANDO**: robot trae data **directa** cada 2h (7d) + 30d/mes cacheados 1×día y la sirve en https://sleve-ecommerce-agents-production.up.railway.app/api/overview (`fuente: GA4 directo (en vivo)`). Períodos en `overview.periodos` |
